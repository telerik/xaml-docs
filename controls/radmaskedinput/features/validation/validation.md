...
{% if site.site_name == 'Silverlight' %}![WPF RadMaskedInput ](images/radmaskedinput_validation_throw_exception_02-sl.png){% endif %}
...
{% if site.site_name == 'Silverlight' %}![WPF RadMaskedInput ](images/radmaskedinput_validation_throw_exception_01-sl.png){% endif %}
