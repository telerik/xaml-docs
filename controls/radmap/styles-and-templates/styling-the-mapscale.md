...
![{{ site.framework_name }} RadMap MapScale Blend Resources](images/RadMap_StylesAndTemplates_StylingMapScale_01.png)
{% endif %}
...
![{{ site.framework_name }} RadMap MapScale Custom Blend Resources](images/RadMap_StylesAndTemplates_StylingMapScale_02.png)

And here is a snapshot of the result:

![{{ site.framework_name }} RadMap Customized Appearance](images/RadMap_StylesAndTemplates_StylingMapScale_03.png)
{% endif %}
