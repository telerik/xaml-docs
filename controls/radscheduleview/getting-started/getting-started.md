...
Before proceeding with adding RadScheduleView to your project, make sure the required assembly references are added to the project. 
...
If you run the application you will see an empty ScheduleView with a message saying that AppointmentsSource should be provided as demonstrated on __Figure 1__. 
...
#### __[C#] Example 3: View Model Containing ObservableCollection of Appointments__
...
#### __[VB.NET] Example 3: View Model Containing ObservableCollection of Appointments__
...
If you run the application at this stage you will see again an empty ScheduleView with a message saying that a View Definition should be selected as shown on __Figure 2__. 
...
>* MonthViewDefinition
> 
>For additional details check [ViewDefinitions Overview]({%slug radscheduleview-viewdefinitions-overview%}) topic.

Running the application containing the code from Examples 1 - 5 will result in a populated __RadScheduleView__ like on __Figure 3__.
...
Using Resources you can associate additional information with the Appointments. Moreover, you can group the Appointments in __RadScheduleView__ according to the Resources assigned to them. For detailed information on this functionality check the [Resources] ({%slug radscheduleview-features-resources%}) topic.
