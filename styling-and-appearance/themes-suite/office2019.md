...
|**MainBorderBrush**|#ACACAC|<div class="theme-palette-color Office2019theme-mainborderbrush"></div>|#A6A6A6|<div class="theme-palette-color Office2019theme-mainborderbrush-gray"></div>|#606060|<div class="theme-palette-color Office2019theme-mainborderbrush-dark"></div>|
...
The theme has a few built-in [color variations](#theme-variation-changing) - Light, Gray and Dark. You can customize the Light variation and make it look like the Microsoft's White Office Theme by changing few color properties of the [theme palette](#office2019palette-properties).
