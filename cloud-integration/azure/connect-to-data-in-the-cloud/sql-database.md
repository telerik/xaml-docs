...
![Telerik UI for WPF ADO.NET Entity Data Model item](images/ado-net-entities.png)

3. Choose **Code First from database** from the **Choose Model Contents** dialog.

![Telerik UI for WPF Entity Framework Choose Model Contents dialog](images/ef-designer.png)
...
![Telerik UI for WPF Entity Data Model wizard database object selection](images/choose-database-models.png)
