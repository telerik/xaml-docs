...
![Telerik UI for {{ site.framework_name }} RadGridView filtering interface showing filtered data in the grid](images/RadGridView_FunctionalOverview_Filtering_1.png)
