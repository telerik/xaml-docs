...
![Telerik UI for WPF RadComboBox in its collapsed state](images/RadComboBox_VisualStructure_01.PNG)
...
![Telerik UI for WPF RadComboBox in its expanded state with the drop-down list open](images/RadComboBox_VisualStructure_02.png)
...
![Telerik UI for WPF RadComboBox in edit mode with its input area visible](images/RadComboBox_VisualStructure_03.png)
