...
>important Resetting the __ItemsSource__ collection will cause __RadGridView's__ horizontal scrollbar to be set to the top. You can keep track of the scroll`s VerticalOffset and reposition the scrollbar after the collection update to keep the original appearance.
