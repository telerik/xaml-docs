...
<snippet id='radrichtextbox-import-export-plain-text-txt-txtformatprovider-block_1-cs' />

And here is how you can import a document from string:
        
__Example 2: Import document from a string__

<snippet id='radrichtextbox-import-export-plain-text-txt-txtformatprovider-block_2-cs' />
...
<snippet id='radrichtextbox-import-export-plain-text-txt-txtformatprovider-block_3-cs' />

You can also export the document to a string and preserve it in a database.

__Example 4: Export a document to a string__

<snippet id='radrichtextbox-import-export-plain-text-txt-txtformatprovider-block_4-cs' />
