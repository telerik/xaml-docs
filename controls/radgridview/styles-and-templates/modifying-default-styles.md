...
![Telerik UI for {{ site.framework_name }} RadGridView in Blend with the Edit Additional Templates menu open](images/RadGridView_Styles_and_Templates_Additional_Styles.png)
...
![Telerik UI for {{ site.framework_name }} RadGridView documentation workflow showing FilteringDropDown selected in the Blend Assets tab](images/RadGridView_Styles_and_Templates_Styling_FilteringControl_1.png)
...
![Telerik UI for {{ site.framework_name }} RadGridView styling workflow with a dummy FilteringDropDown placed on the Blend design surface](images/RadGridView_Styles_and_Templates_Styling_FilteringControl_2.png)
...
![Telerik UI for {{ site.framework_name }} RadGridView styling workflow showing the Create Style Resource dialog in Blend](images/RadGridView_Styles_and_Templates_Styling_FilteringControl_7.png)
...
![Telerik UI for {{ site.framework_name }} RadGridView styling workflow showing the FilteringDropDown template structure in Blend](images/RadGridView_Styles_and_Templates_Styling_FilteringControl_4.png)
...
![Telerik UI for {{ site.framework_name }} RadGridView styling workflow changing the FilteringDropDown path fill in Blend](images/RadGridView_Styles_and_Templates_Styling_FilteringControl_5.png)

Here is a snapshot of the final result:

#### __Figure 7: The modified FilteringDropDown__

![Telerik UI for {{ site.framework_name }} RadGridView with the modified FilteringDropDown style applied](images/RadGridView_Styles_and_Templates_Styling_FilteringControl_6.png)
...
![Telerik UI for {{ site.framework_name }} RadGridView in Visual Studio Design view while modifying default styles](images/RadGridView_Styles_and_Templates_Visual_Studio_Design_View.png)
