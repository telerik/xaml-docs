...
The .xaml files inside the __WPF__ folder are meant for **.NET Framework 4.6.2**. The .xaml files inside the __NetCore__ contains the resources for the __.NET 6__ and __.NET 7__ frameworks. 
