...
position: 1
---
<<Comment: I don't think you need the words "and" or "with" in tags. The tags should include ScheduleViewDragDropBehavior for SEO.>>
...
<<Comment: I have never read "is held with the mouse" before. I think you mean when the user clicks and holds down a mouse button. I suggest, "Holds a reference to the appointment that the user selects when they hold down the click button.">>
...
<<Comment: What are slots? Are they a collection of times when the user has selected one or more appointments? (I only guessed this because I read further down the page and saw slot duration and ticks.) I think you should explain what slots are.>>
