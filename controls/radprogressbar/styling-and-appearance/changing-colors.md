...
* __Background__: Modifies the color of the progress track.						
	...
	<snippet id='radprogressbar-styling-and-appearance-changing-colors-block_1-xaml' />

	__Example 2: Setting a yellow background in code-behind__
	<snippet id='radprogressbar-styling-and-appearance-changing-colors-block_2-cs' />
	<snippet id='radprogressbar-styling-and-appearance-changing-colors-block_2-vb' />
...
* __Foreground__: Modifies the color of the progress indicator.						
	...
	<snippet id='radprogressbar-styling-and-appearance-changing-colors-block_3-xaml' />

	__Example 4: Setting a yellow indicator in code-behind__
	<snippet id='radprogressbar-styling-and-appearance-changing-colors-block_4-cs' />
	<snippet id='radprogressbar-styling-and-appearance-changing-colors-block_4-vb' />
...
* __BorderBrush__: Modifies the color of the RadProgressBar outer border.					
	...
	<snippet id='radprogressbar-styling-and-appearance-changing-colors-block_5-xaml' />

	__Example 6: Setting a red border brush in code-behind__
	<snippet id='radprogressbar-styling-and-appearance-changing-colors-block_6-cs' />
	<snippet id='radprogressbar-styling-and-appearance-changing-colors-block_6-vb' />
