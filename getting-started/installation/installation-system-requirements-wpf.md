...
* __Microsoft Visual Studio 2010/2012/2013/2015/2017/2019__ - download from [here](https://visualstudio.microsoft.com/downloads/).
        
* __.NET Framework 4.0, .NET 4.5, .NET 4.5.1, .NET 4.5.2 or .NET 4.6__ - download .NET 4.0 from [here](https://www.microsoft.com/en-us/download/details.aspx?id=17851), .NET 4.5 from [here](http://www.microsoft.com/en-us/download/details.aspx?id=30653), .NET 4.5.1 from [here](http://www.microsoft.com/en-us/download/details.aspx?id=40779), .NET 4.5.2 from [here](http://www.microsoft.com/en-us/download/details.aspx?id=42642) or .NET 4.6 from [here](https://www.microsoft.com/en-us/download/details.aspx?id=48130).

>tip Since R1 2019, .NET Core 3 is also supported. Download it from [here](https://dotnet.microsoft.com/download/dotnet-core/3.0).
          
* __Microsoft Expression Blend(optional)__
