...
![WPF RadChartView ScatterSplineAreaSeries with Spline Tension 0.8 (Left) and 0.4 (Right)](images/splineseries-splinearea-tension.png)
...
![WPF RadChartView ScatterSplineAreaSeries with SplinePointsDistanceFactor set to 0.18](images/splineseries-splinearea-points-distance-factor.png)
