...
__RadWatermarkTextBox__ control represents a TextBox that shows a different content when empty and not focus. It provides the ability to display useful information when having TextBox controls that are not focused, or does not contain text.
