...
* Enable check boxes next to each item - declaratively and programmatically.		  
	...
	* Access the initially checked item when using the "tri-state" feature of the check boxes.			  
...
<snippet id='radtreeview-features-check-box-support-block_1-xaml' />
...
<snippet id='radtreeview-features-check-box-support-block_2-xaml' />
...
<snippet id='radtreeview-features-check-box-support-block_3-cs' />
<snippet id='radtreeview-features-check-box-support-block_4-vb' />
...
<snippet id='radtreeview-features-check-box-support-block_5-xaml' />
...
<snippet id='radtreeview-features-check-box-support-block_6-cs' />
<snippet id='radtreeview-features-check-box-support-block_7-vb' />
...
<snippet id='radtreeview-features-check-box-support-block_8-cs' />
...
<snippet id='radtreeview-features-check-box-support-block_9-xaml' />
...
<snippet id='radtreeview-features-check-box-support-block_10-cs' />
<snippet id='radtreeview-features-check-box-support-block_11-vb' />
