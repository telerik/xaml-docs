...
{{region radupload-features-file-size-and-count-limitation_0}}
...
>tipYou can see the size of each file in the list on the right side of its container.
...
{{region radupload-features-file-size-and-count-limitation_1}}
...
>tipYou can see the total size of the files in the list on the right side of the total details container.
...
{{region radupload-features-file-size-and-count-limitation_2}}
