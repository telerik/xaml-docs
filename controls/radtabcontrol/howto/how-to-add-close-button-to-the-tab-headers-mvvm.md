...
description: Check our "How to Add Close and Create Buttons to the Tab Headers using MVVM approach" documentation article for the RadTabControl WPF control.
