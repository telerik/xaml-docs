...
![WPF RadSlider Increase Decreease Handles Visible](images/radslider_features_handles.png)
...
![WPF RadSlider Range Handles](images/radslider_features_handles_range.png)
