...
The last thing that needs to be done is to make the __Title__ area display
...
Now if you run the project, everything should be fine.![](images/RadOutlookBar_Prism_15.png)
