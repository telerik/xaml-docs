...
The control exposes the following events&mdash;`DirectoryRequesting`, `ExceptionRaised`, and `Renaming`. Read more about the events and their arguments in the [Events]({%slug radfiledialogs-events%}) article.
