---
title: Calculations with XmlaDataProvider
page_title: Calculations with XmlaDataProvider
...
# Calculations with XmlaDataProvider
...
There are several predefined calculations that you can use. To explain each of them we will use the below __RadPivotGrid__ and we will apply the calculations
        ...
        ![Rad Pivot Grid Features Calculations OLAP 01](images/RadPivotGrid_Features_Calculations_OLAP_01.png)
