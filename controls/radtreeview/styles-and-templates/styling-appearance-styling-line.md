...
![WPF RadTreeView Connected Lines Red Color](images/RadTreeView_StylingAndAppearance_StylingLines_010.png)
...
![WPF RadTreeView TreeView_LineColor Resource Blend](images/RadTreeView_StylingAndAppearance_StylingLines_040.png)
...
* Modify the __TreeView_LineColor__ resource, which represents the __Stroke__ of the horizontal and vertical lines connecting the nodes. For example, change the color to __Red__. 
	...
	![WPF RadTreeView TreeView_LineColor Changed to Red](images/RadTreeView_StylingAndAppearance_StylingLines_050.png)
