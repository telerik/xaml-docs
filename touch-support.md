...
RadMap | Pan	|	Zoom	|	Click/Select	|	-	|	-	|	Double Tap -> Zoom
...
RadTreeView | Scroll with Inertia	|	-	|	Click/Select/Expand	|	-	|	Show touch Indicator	|	Tap and Hold and Move will Start Drag operation
