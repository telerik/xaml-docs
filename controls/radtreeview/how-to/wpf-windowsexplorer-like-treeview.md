...
![WPF RadTreeView Like Windows Explorer](images/RadTreeView_HowToWindowsExplorerTree_005_WPF.PNG)
...
4. Go back to your treeview declaration and bind the control to the just created model. __Example 7__ shows how this can be done:
	...
	![WPF RadTreeView Drives](images/RadTreeView_HowToWindowsExplorerTree_020_WPF.PNG)
...
5. Create a new class named __ItemStyleSelector__, which inherits from __StyleSelector__.
	...
	* Uses a simple trigger to change the Foreground and the __FontStyle__ properties of the __RadTreeViewItem__ when the item is expanded.				
	...
	![WPF RadTreeView Expanding Drives](images/RadTreeView_HowToWindowsExplorerTree_030_WPF.PNG)
...
![WPF RadTreeView Like Windows Explorer](images/RadTreeView_HowToWindowsExplorerTree_040_WPF.PNG)
