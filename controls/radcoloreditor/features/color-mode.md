...
<snippet id='radcoloreditor-features-color-mode-example_1_set_the_color_model_to_rgb-xaml' />
...
* __RGB__: Sets the color model to [RGB(Red, Green and Blue)](http://en.wikipedia.org/wiki/RGB_color_model)  
	...
	<snippet id='radcoloreditor-features-color-mode-example_2_set_the_color_model_to_hls-xaml' />
...
* __HLS__: Sets the color model to [HLS (Hue, Luminance and Saturation)](http://en.wikipedia.org/wiki/HSL_and_HSV)  
	...
	<snippet id='radcoloreditor-features-color-mode-example_3_set_the_color_model_to_hsv-xaml' />
...
* __HSV__: Sets the color model to [HSV (Hue, Saturation and Value)](http://en.wikipedia.org/wiki/HSL_and_HSV)  
	...
	<snippet id='radcoloreditor-features-color-mode-example_4_set_the_color_model_to_cmyk-xaml' />
