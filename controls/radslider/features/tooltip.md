...
You can change the postion of the tool tip by setting the Orientation and AutoToolTipPlacement properties. The following pictures displays the different position of the tool tip.
