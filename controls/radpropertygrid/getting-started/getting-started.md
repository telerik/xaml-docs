...
* Binding to a data item - you may bind RadPropertyGrid to a single data item. Thus, you will be able to examine and edit its properties. The only thing you need is to set the Item property of RadPropertyGrid. The binding may be performed both in xaml and in code-behind.
...
* Binding to a visual element - you may bind the Item property of RadPropertyGrid to a visual element and then be able to view and edit its properties. The binding may be performed both in xaml and in code-behind:

#### __[XAML]Example 5: Binding to a visual element__
...
When you run the application, RadPropertyGrid will be visualized as follows:

![](images/RadPropertyGrid_GettingStarted3.png)



## Binding the PropertyDefinition to an existing property
...
#### __[XAML]Example 6: Binding to a property of the data item__
...
__IsGrouped__ - since the Q3 2011 version of the RadControls, we have added a property that controls the current RadPropertyGrid's state. You can set it to true in the xaml and you will have an initially grouped RadPropertyGrid. Or you can set it to false and you will have the GridView sorted.
