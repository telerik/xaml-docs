...
![WPF RadChartView RangeSplineSeries with Spline Tension 0.8 (Left) and 0.4 (Right)](images/splineseries-rangespline-tension.png)
...
![WPF RadChartView RangeSplineSeries with SplinePointsDistanceFactor Set to 0.18](images/splineseries-rangespline-points-distance-factor.png)
