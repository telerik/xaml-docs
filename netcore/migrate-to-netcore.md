...
1. Create a new __.NET__ application using Visual Studio. 
	...
	![Telerik UI for WPF Visual Studio dialog for creating a new .NET project](images/netcore-support-migration-0.png)	
...
2. Add the existing files from the original project as linked files to the .NET project.
	...
	![Telerik UI for WPF Visual Studio Add Existing Item dialog for a .NET project](images/netcore-support-migration-1.png)
	
	![Telerik UI for WPF .NET project with files linked from the original project](images/netcore-support-migration-2.png)
...
3. Reference the Telerik assemblies built against .NET.
	...
	![Telerik UI for WPF assembly properties showing a .NET 8 target](images/netcore-support-migration-3.png)
