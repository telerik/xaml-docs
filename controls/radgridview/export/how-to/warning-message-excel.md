...
![Telerik UI for {{ site.framework_name }} RadGridView Excel warning dialog showing a file format and extension mismatch after export](images/gridview_troubleshoot_export.png)
