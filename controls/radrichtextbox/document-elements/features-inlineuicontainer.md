...
![WPF RadRichTextBox Inline UI Container](images/RadRichTextBox_Features_LayoutElements_InlineUIContainer_01.png)
...
* __PdfFormatProvider__: The __InlineUIContainers__ are taken a snapshot of and included in the export. If you like, you can prevent that by setting the __InlineUIContainersExportMode__ property of the provider to __None__.
	![WPF RadRichTextBox Inline UI Containers Export Mode None](images/RadRichTextBox_Features_LayoutElements_InlineUIContainer_02.png)
