...
<snippet id='radmap-features-export-support-block_1-cs' />

__Example 2: Save the image using a stream__
<snippet id='radmap-features-export-support-block_2-cs' />
...
<snippet id='radmap-features-export-support-block_3-cs' />
...
<snippet id='radmap-features-export-support-block_4-cs' />
