...
>important Resetting the __ItemsSource__ collection will cause __RadGridView's__ horizontal scrollbar position to be set to the top. You can keep track of the vertical scroll offset and reposition the scrollbar after the collection update as a workaround.
