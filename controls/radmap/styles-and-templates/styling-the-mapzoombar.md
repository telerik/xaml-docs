...
{% if site.site_name == 'Silverlight' %}
![WPF RadMap MapZoomBar Blend Resources](images/RadMap_StylesAndTemplates_StylingMapZoomBar_01.png)
{% endif %}
...
![WPF RadMap MapZoomBar Custom Blend Resources](images/RadMap_StylesAndTemplates_StylingMapZoomBar_02.png)

And here is a snapshot of the result:

![WPF RadMap MapZoomBar Customized Appearance](images/RadMap_StylesAndTemplates_StylingMapZoomBar_03.png)
{% endif %}
