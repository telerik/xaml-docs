...
![Telerik UI for {{ site.framework_name }} RadGridView data selection showing selected items in the grid](images/RadGridView_FunctionalOverview_Selection_1.png)
