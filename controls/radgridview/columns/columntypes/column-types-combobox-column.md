...
* __IsLightWeightModeEnabled__ - introduced in __R2 2016__. Its default value is __False__. When set to __True__, the new lightened lookup logic is triggered, thus the performance of GridViewComboBoxColumn is significantly increased. *In case of nested properties the value is always false*. 
