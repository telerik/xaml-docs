...
![Telerik UI for {{ site.framework_name }} RadGridView showing a column being resized by dragging its header boundary](images/RadGridView_ResizingColumns_1.png)
