...
* __Integrations between applications__: DragDropManager has build-in support for dragging from and to external programs, allowing easy interaction between applications.
