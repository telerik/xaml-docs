...
__RadBusyIndicator__  supports two main modes of execution that could be used to determinate <Comment: I do not know what this means. I think you mean a different word but while determined could fit, visualize or show progress seem more visual to me.> the progress of the control - determined and indetermined. If you need a determined __RadBusyIndicator__ you have to set the value of the __IsIndeterminated__ property to __False__. Please, check [this]({%slug radbusyindicator-features-progress-determination%}) article for some information concerning the progress determination of __RadBusyIndicator__.
