...
{{region radtilelist-features-selection_0}}
...
>importantThe __SelectedItems__ collection will remain empty when SelectionMode is set to Single and you change the selected item. However, when in Multiple of Extended selection mode, __SelectedItem__ will be set to the last item added to the selected items that is still included in the selection.
...
{{region radtilelist-features-selection_1}}
...
{{region radtilelist-features-selection_2}}
