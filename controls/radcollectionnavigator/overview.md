...
# {{ site.framework_name }} CollectionNavigator Overview

Thank you for choosing __RadCollectionNavigator__!				

__RadCollectionNavigator__ provides UI for seamless editing and navigation of a given data collection.
...
* [Telerik UI for WPF CollectionNavigator Homepage](https://www.telerik.com/products/wpf/collection-navigator.aspx)
* [Get Started with the Telerik UI for WPF CollectionNavigator]({%slug collectionnavigator_getting_started%})
* [Telerik UI for WPF API Reference](https://docs.telerik.com/devtools/wpf/api/)
* [Getting Started with Telerik UI for WPF Components]({%slug getting-started-first-steps%})
* [Telerik UI for WPF Virtual Classroom (Training Courses for Registered Users)](https://learn.telerik.com/learn/course/external/view/elearning/16/telerik-ui-for-wpf) 
* [Telerik UI for WPF CollectionNavigator Forums](https://www.telerik.com/forums/wpf)
