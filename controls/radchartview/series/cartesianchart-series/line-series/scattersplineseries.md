...
![WPF RadChartView ScatterSplineSeries with Spline Tension 0.8 (Left) and 0.4 (Right)](images/splineseries-spline-tension.png)
...
![WPF RadChartView ScatterSplineSeries with SplinePointsDistanceFactor set to 0.18](images/splineseries-spline-points-distance-factor.png)
