...
![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate_100.png)
...
* Open your page in Expression Blend.
	...
	![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate.png)
...
* Press the "__Edit resource__" button (located next to each template) for the __League__ template. This will open the current template for edit. Drag and drop the controls you need for the template and configure their properties. In the example are used an __Image__ and a __TextBlock__ controls: 
	![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate_010.png){% if site.site_name == 'Silverlight' %}
	...
	![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate_020.png)

	Go to the "__Properties__" pane and find the __Source__ property in the __Common properties__ section. 
	![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate_030.png)
	...
	![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate_040.png)
	...
	![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate_050.png)
	...
	![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate_060.png)

	Find and set the following properties in the "__Properties__" pane:
	
	* __ItemsSource__
	
		![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate_070.png)
	* __ItemTemplate__
		
		![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate_080.png)
...
* The final step is to select your treeview and to set the __ItemTemplate__ property:
	![WPF RadTreeView ](images/RadTreeView_TemplatingItemTemplate_090.png)
