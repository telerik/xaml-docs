...
Like most {% if site.site_name == 'Silverlight' %}Silverlight{% endif %}{% if site.site_name == 'WPF' %}WPF{% endif %} controls, the __RadGridView__ also allows you to template it in order to change the control from the inside. Except for templating the whole control, you can template parts of it or even independent controls related to it. This topic will make you familiar with the:

* [RadGridView Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#-radgridview)

* [GridViewCell Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#gridviewcell)

* [GridViewHeaderCell Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#gridviewheadercell)

* [GridViewFooterCell Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#gridviewfootercell)

* [GridViewRow Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#gridviewrow-)

* [GridViewHeaderRow Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#gridviewheaderrow)

* [GridViewGroupRow/GroupHeaderRow Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#gridviewgrouprow/groupheaderrow)

* [GridViewGroupPanel Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#gridviewgrouppanel)

* [GridViewGroupPanelItem Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#gridviewgrouppanelitem)

* [GridViewGroupFooterCell Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#gridviewgroupfootercell)

* [DetailsPresenter Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#detailspresenter)

* [Filtering Control Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#filteringcontrol)

* [New Row Template Structure](2CD6EAA0-C735-4FA2-B921-A0D1A4452C10#gridviewnewrow)
...
## GridViewHeaderCell![](images/RadGridView_Styles_and_Templates_Templates_Structure_GridViewHeaderCell.png)
...
## GridViewFooterCell![](images/RadGridView_Styles_and_Templates_Templates_Structure_GridViewFooterCell.png)
...
## GridViewGroupRow/GroupHeaderRow![](images/RadGridView_Styles_and_Templates_Templates_Structure_GridViewGroupRow.png)
...
* [Border] - represents the inner border and the background of the group row indicator and is of type __Border__.
...
## GridViewGroupPanel![](images/RadGridView_Styles_and_Templates_Templates_Structure_GridViewGroupPanel.png)
...
## GridViewGroupPanelItem![](images/RadGridView_Styles_and_Templates_Templates_Structure_GridViewGroupPanelItem.png)
...
## GridViewGroupFooterCell![](images/RadGridView_Styles_and_Templates_Templates_Structure_GridViewGroupFooterCell.png)
...
## DetailsPresenter![](images/RadGridView_Styles_and_Templates_Templates_Structure_DetailsPresenter.png)
...
## FilteringControl![](images/template_structure_filtering_control_gridview.png)
...
## GridViewNewRow![](images/newrow_template_gridview.png)
