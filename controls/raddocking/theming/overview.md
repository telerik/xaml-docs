...
![WPF RadDocking Custom Theme Silverlight](images/RadDocking_ThemingOverview_01.png){% endif %}{% if site.site_name == 'Silverlight' %}
...
![WPF RadDocking Custom Theme WPF](images/RadDocking_ThemingOverview_02.png){% endif %}{% if site.site_name == 'WPF' %}
