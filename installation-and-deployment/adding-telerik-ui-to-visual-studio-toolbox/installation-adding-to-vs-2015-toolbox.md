...
1. Select the "UI for WPF" tab in the toolbox. Right-mouse click and select "Choose Items...".

	![Common Installing Adding ToVS 2015 Tool Box 030 WPF](images/Common_InstallingAddingToVS2015ToolBox_03.png)

1. In the "Choose Toolbox Items" dialog, go to the "WPF Components" tab and click "Browse...".
...
1. Expand your toolbox. You will see the newly added controls in the "UI for WPF" section.
