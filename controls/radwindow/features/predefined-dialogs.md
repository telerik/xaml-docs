...
For more info about the class read {% if site.site_name == 'Silverlight' %}[here](https://docs.telerik.com/devtools/silverlight/api/html/t_telerik_windows_controls_dialogparameters.htm){% endif %}{% if site.site_name == 'WPF' %}[here](https://docs.telerik.com/devtools/wpf/api/html/t_telerik_windows_controls_dialogparameters.htm){% endif %}.
