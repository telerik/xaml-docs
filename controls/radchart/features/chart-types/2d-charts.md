...
* Bar
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Bar2D_thumb.png)
...
* Stacked Bar
![{{ site.framework_name }} RadChart  ](images/RadChart_types_StackedBar2D_thumb.png)
...
* Stacked Bar 100
![{{ site.framework_name }} RadChart  ](images/RadChart_types_StackedBar1002D_thumb.png)
...
* Horizontal Bar
![{{ site.framework_name }} RadChart  ](images/RadChart_types_HorizontalBar2D_thumb.png)
...
![{{ site.framework_name }} RadChart  ](images/RadChart_types_HorizontalStackedBar2D_thumb.png)
...
![{{ site.framework_name }} RadChart  ](images/RadChart_types_HorizontalStackedBar1002D_thumb.png)
...
* Line
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Line2D_thumb.png)
...
* Stacked Line
![{{ site.framework_name }} RadChart  ](images/RadChart_types_StackedLine2D_thumb.png)
...
* Area
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Area2D_thumb.png)
...
* Stacked Area
![{{ site.framework_name }} RadChart  ](images/RadChart_types_StackedArea2D_thumb.png)
...
* Stacked Area 100%
![{{ site.framework_name }} RadChart  ](images/RadChart_types_StackedArea1002D_thumb.png)
...
* Range
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Range2D_thumb.png)
...
* Spline Range
![{{ site.framework_name }} RadChart  ](images/RadChart_types_SplineRange2D_thumb.png)
...
* Spline
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Spline2D_thumb.png)
...
* Stacked Spline
![{{ site.framework_name }} RadChart  ](images/RadChart_types_StackedSpline2D_thumb.png) The Stacked Spline chart is a variation of Spline chart. The areas are stacked so that each series adjoins but does not overlap the preceding series. Use the Stacked Spline when you need to show the correlation between two or more series of data visualized as splines.

* Spline Area
![{{ site.framework_name }} RadChart  ](images/RadChart_types_SplineArea2D_thumb.png)
...
* Stacked Spline Area
![{{ site.framework_name }} RadChart  ](images/RadChart_types_StackedSplineArea2D_thumb.png)
...
![{{ site.framework_name }} RadChart  ](images/RadChart_types_StackedSplineArea1002D_thumb.png)
...
* Bubble
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Bubble2D_thumb.png)
...
* Stick
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Stick_thumb.png)
...
* CandleStick
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Candlestick_thumb.png)
...
* Pie
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Pie2D_thumb.png)
...
* Doughnut
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Doughnut2D_thumb.png)
...
* Scatter
![{{ site.framework_name }} RadChart  ](images/RadChart_types_Scatter_thumb.png)
...
* Step Line
![{{ site.framework_name }} RadChart  ](images/RadChart_types_StepLine_thumb.png)
...
* Step Area
![{{ site.framework_name }} RadChart  ](images/RadChart_types_StepArea_thumb.png)
...
* Range Bar
![{{ site.framework_name }} RadChart  ](images/RadChart_types_RangeBar_thumb.png)
