...
Thank you for choosing the [Telerik UI for WPF product suite](https://www.telerik.com/products/wpf/overview.aspx).
...
To learn more, visit the [Telerik UI for WPF product overview page](https://www.telerik.com/products/wpf/overview.aspx).
...
* License holders and active trialists can take advantage of our outstanding customer support delivered by the developers building the library. To submit a support ticket, use the [Telerik UI for WPF support ticket system](https://www.telerik.com/account/support-tickets?pid=601&q=&supcId=daf62541-57e0-b84c-8b5e-da9851c61873&fbp=false).
* Our [Telerik UI for WPF forums](https://www.telerik.com/forums/wpf) can help you get assistance from the community and also from the team on all kinds of general issues.
* Our [Telerik UI for WPF feedback portal](https://feedback.telerik.com/wpf) provides information on the features and bugs in discussion and also the planned ones for release.
* You may still need a tailor-made solution for your project. In such cases, go straight to [Progress custom development services](https://www.progress.com/services).

## Learning Resources

* [Telerik UI for WPF Knowledge Base articles](https://docs.telerik.com/devtools/wpf/knowledge-base)

## Installation and Deployment

To learn how to install Telerik UI for WPF and review the full list of controls and their assemblies, visit the [WPF installation and deployment guides]({%slug installation-guide%}).

## Consuming Data

To learn more about the different approaches for populating the Telerik &reg; UI for WPF controls, visit the [WPF data binding and data consumption guides]({%slug consuming-data-overview%}).

## Styling and Appearance

To find how to customize the look of Telerik UI for WPF and use our predefined themes, visit the [WPF styling and appearance guides]({%slug styling-apperance-implicit-styles-overview%}).
...
* [Telerik UI blogs](https://www.telerik.com/blogs)
