...
1. Browse and download the needed files.

When it comes to installation, most of the time, you may not need to download product files. Instead, you can use the [Telerik CLI]({%slug telerik-cli%}) to setup the development environment and [NuGet packages]({%slug installation-guide%}#tab-1-nuget-installation) to add the Telerik assemblies in the project.
