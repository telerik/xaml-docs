...
#number-of-requests
A Telerik [Subscription license](https://www.telerik.com/purchase/faq/licensing-purchasing) is required in order to use the Telerik WPF AI Coding Assistant. Trial users can make a [limited number of requests per year]({%slug ai-overview%}#usage-limits).
#end
