...
>tip The __GridView__ also exposes two style properties - __GroupPanelStyle__ and __GroupPanelItemStyle__. To learn how to use them in order to style the __Group Panel__ read [here]({%slug radgridview-styles-and-templates-styling-the-group-panel%}).
...
<snippet id='radgridview-grouping-modifying-group-panel-block_1-xaml' />
...
<snippet id='radgridview-grouping-modifying-group-panel-block_2-xaml' />
