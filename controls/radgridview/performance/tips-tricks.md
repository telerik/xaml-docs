...
* As of __R2 2016__ GridViewComboBoxColumn exposes new property - __IsLightWeightModeEnabled__. Setting it to true significantly increases the RadGridView`s performance.
