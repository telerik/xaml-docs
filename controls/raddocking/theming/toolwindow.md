...
{{region raddocking-theming-toolwindow_0}}
...
{{region raddocking-theming-toolwindow_1}}
	<ResourceDictionary xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
	                    xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml"
...
{{region raddocking-theming-toolwindow_2}}
...
{{region raddocking-theming-toolwindow_3}}
...
{{region raddocking-theming-toolwindow_4}}
	Public Sub New()
	    InitializeComponent()
...
{{region raddocking-theming-toolwindow_5}}
