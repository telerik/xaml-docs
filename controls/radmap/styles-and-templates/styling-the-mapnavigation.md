...
{% if site.site_name == 'Silverlight' %}
![WPF RadMap MapNavigation Blend Resources](images/RadMap_StylesAndTemplates_StylingMapNavigation_01.png)
{% endif %}
...
![WPF RadMap MapNavigation Custom Blend Resources](images/RadMap_StylesAndTemplates_StylingMapNavigation_02.png)

And here is a snapshot of the result:

![WPF RadMap MapNavigation Customized Appearance](images/RadMap_StylesAndTemplates_StylingMapNavigation_03.png)
{% endif %}
