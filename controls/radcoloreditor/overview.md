...
Thank you for choosing Telerik __RadColorEditor__ control! 
...
* __Color Mode__: RadColorEditor control provides support for most populate color modes. [Read more]({%slug radcoloreditor-features-color-mode%})
...
* __Active Sections__: You can easly customize the __RadColorEditor__ control. Using active sections functionality you can combine/remove different parts of the control. [Read more]({%slug radcoloreditor-activesections%})
