...
>tipDetailed information on the different validation rules is available in the [Data Validation for SpreadProcessing article]({%slug radspreadprocessing-features-data-validation%}).
...
[Data Validation for SpreadProcessing article]({%slug radspreadprocessing-features-data-validation%})
