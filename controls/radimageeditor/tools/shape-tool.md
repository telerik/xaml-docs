...
{{region radimageeditor-tools-shape-tool_1}}
...
{{region radimageeditor-tools-shape-tool_2}}

	public class TelerikLogo : IShape
{{endregion}}

#### __[VB] Example 3: Inherit the IShape Interface__
{{region radimageeditor-tools-shape-tool_6}}
...
{{region #region radimageeditor-tools-shape-tool_3}}
...
{{region #region radimageeditor-tools-shape-tool_7}}
    ...
    Public Function GetShapeGeometry() As Geometry
...
{{region radimageeditor-tools-shape-tool_8}}
...
#### __[XAML] Example 6: Add Custom Shape to the Shape Tool__
{{region radimageeditor-tools-shape-tool_5}}
