...
* __Various data sources__ - This example demonstrates how to bind RadGridView to different DataSources.{% endif %}{% if site.site_name == 'Silverlight' %}
...
* __Validation with INotifyDataErrorInfo Interface__ - 
This example demonstrates how to perform validation with INotifyDataErrorInfo Interface.{% endif %}
