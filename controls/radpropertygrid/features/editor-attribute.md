...
* [public  EditorAttribute(Type editorType)](33f1dce2-0b7d-43b4-af52-4312258b380a#editorattribute(type-editortype))

* [public EditorAttribute(Type editorType, EditorStyle editorStyle) ](33f1dce2-0b7d-43b4-af52-4312258b380a#editorattribute(type-editortype,-editorstyle-editorstyle))

* [public EditorAttribute(Type editorType, string targetProperty)](33f1dce2-0b7d-43b4-af52-4312258b380a#editorattribute(type-editortype,-string-targetproperty))

* [public EditorAttribute(Type editorType, string targetProperty, EditorStyle editorStyle)](33f1dce2-0b7d-43b4-af52-4312258b380a#editorattribute(type-editortype,-string-targetproperty,-editorstyle-editorstyle))
...
## EditorAttribute(Type editorType)

public EditorAttribute(Type editorType) – only the type of the editor can be specified. 
...
public EditorAttribute(Type editorType, EditorStyle editorStyle) – the type of the editor and the style of the containing host:
...
public EditorAttribute(Type editorType, string targetProperty) – the type of the editor and its property that you want to bind to. For instance:
...
public EditorAttribute(Type editorType, string targetProperty, EditorStyle editorStyle) – with this constructor all properties are set – the type of the editor, its property that will be used for the binding and the type of the host it will be placed inside. For example:
