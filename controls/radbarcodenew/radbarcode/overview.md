...
permalink: /controls/radbarcode/oldbarcode/overview
---

# Overview

{% if site.site_name == 'Silverlight' %}![](../../radbarcodenew/radbarcode/images/radbarcode-overview-sl-0.png){% endif %}
{% if site.site_name == 'WPF' %}![](../../radbarcodenew/radbarcode/images/radbarcode-overview-wpf-0.png){% endif %}
