...
<snippet id='radpersistenceframework-persistence-framework-getting-started-block_1-xaml' />
...
<snippet id='radpersistenceframework-persistence-framework-getting-started-block_2-cs' />
<snippet id='radpersistenceframework-persistence-framework-getting-started-block_2-vb' />
...
<snippet id='radpersistenceframework-persistence-framework-getting-started-block_3-xaml' />

you can save the __treeView__ properties in a stream like so:		


<snippet id='radpersistenceframework-persistence-framework-getting-started-block_4-cs' />
<snippet id='radpersistenceframework-persistence-framework-getting-started-block_4-vb' />

Later the layout of the __RadTreeView__ can be restored through the __Load()__ method:		


<snippet id='radpersistenceframework-persistence-framework-getting-started-block_5-cs' />
<snippet id='radpersistenceframework-persistence-framework-getting-started-block_5-vb' />
