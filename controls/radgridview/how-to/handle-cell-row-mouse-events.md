...
description: Check out our article demonstrating how to add handlers for the various mouse events to the cell and row elements in RadGridView - Telerik's WPF DataGrid.
